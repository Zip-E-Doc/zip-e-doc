            ...
            <tbody>
              {documentList.map((document, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {document.createdDate ? <TextFormat type="date" value={document.createdDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {document.modifiedDate ? <TextFormat type="date" value={document.modifiedDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{document.s3key}</td>
                  <td>{document.userName ? document.userName.login : ''}</td>
