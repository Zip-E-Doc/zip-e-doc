...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHAREDUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHAREDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHAREDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHAREDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHAREDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHAREDUSER actions', async () => {
      const expectedActions = [
        {
